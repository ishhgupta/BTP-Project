...
const UserCard = ({ user }) => {
  return (
    ...
    >
      {/* <Grid> */}
      <Grid item xs={8}>
      <TextField required id="outlined-required" label="UserName"defaultValue={user.username}/>
      </Grid>
      <Grid item xs={8}>
      <TextField required id="outlined-required" label="Email"defaultValue={user.email}/>
      </Grid>
    </Card>
    // </Grid>
  );
